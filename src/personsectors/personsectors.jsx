        ...
        <Box sx={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            ...
            <Select
              ...
              input={<OutlinedInput label="Sectors Input" />}
          ...
          <Stack alignItems="center" mt={3}>
            <Button
              ...
              variant="contained"
            >
              {updating ? "Udpdate Record" : "Save Record"}
            </Button>
          </Stack>
        </Box>
      </form>
